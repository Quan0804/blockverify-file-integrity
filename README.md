...
<div align="center">
  ...
  <p><b>Giao diện Tính năng Upload & Đăng ký</b></p>
</div>
...
<div align="center">
  ...
  <p><b>Tra cứu thông tin FileID & Đối chiếu hash</b></p>
</div>
...
### 4.2. Clone project
```bash
git clone https://github.com/Quan0804/btl.git
```
*(Bạn có thể thay đổi đường dẫn repo nếu cần)*
